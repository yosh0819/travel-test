...
<head>
    ...
    <title>Hiriketiya Airport Taxi</title>
...
<header>
    <a href="#">Home</a> / Taxi Service / Hiriketiya Airport Taxi
    <h1>Hiriketiya Airport Taxi</h1>
...
<section class="taxi-details">
    <img id="vehicle-image" src="Hiriketiya-Airport-Taxi-s.webp" alt="Hiriketiya Taxi">
    <div class="details">
        <h2 id="vehicle-price">$80.17 – $582.03</h2>
        <p>Join us for an unforgettable Hiriketiya Airport Taxi! Covers everything you need for a smooth and enjoyable transport.</p>
        <ul>
            <li>Hiriketiya to Airport & Airport to Hiriketiya</li>
            <li>Included: Transport, government tax</li>
        </ul>
        <h3>Vehicles</h3>
        <div class="vehicle-buttons">
            <button onclick="selectVehicle('mini-car', 'mini-car.webp', 80.17)">Mini Car</button>
            <button onclick="selectVehicle('sedan-car', 'sedan-car.webp', 164.30)">Sedan Car</button>
            <button onclick="selectVehicle('flat-roof-van', 'flat-roof-van.webp',267.25)">Flat Roof Van</button>
            <button onclick="selectVehicle('high-roof-van', 'high-roof-van.webp', 365.60)">High Roof Van</button>
            <button onclick="selectVehicle('mini-coach-bus', 'mini-coach-bus.webp', 582.03)">Mini Coach Bus</button>
        </div>
...
/*document.getElementById("bookingForm").addEventListener("submit", function(event) {
    ...
    updateCartCount();
        ...
        document.getElementById("vehicle-image").src = "Hiriketiya-Airport-Taxi-s.webp";
        document.getElementById("vehicle-price").textContent = "$80.17 – $582.03";
        selectedPrice = 0;
        updateTotalPrice();
        document.querySelectorAll(".vehicle-buttons button").forEach(button => button.classList.remove("active"));
