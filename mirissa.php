...
<head>
    ...
    <title>Mirissa Airport Taxi</title>
...
<header>
    <a href="#">Home</a> / Taxi Service / Mirissa Airport Taxi
    <h1>Mirissa Airport Taxi</h1>
...
<section class="taxi-details">
    <img id="vehicle-image" src="Mirissa-Airport-Taxi-s.webp" alt="Mirissa Taxi">
    <div class="details">
        <h2 id="vehicle-price">$65.04 – $528.00</h2>
        <p>Join us for an unforgettable Mirissa Airport Taxi! Covers everything you need for a smooth and enjoyable transport.</p>
        <ul>
            <li>Mirissa to Airport & Airport to Mirissa</li>
            <li>Included: Transport, government tax</li>
        </ul>
        <h3>Vehicles</h3>
        <div class="vehicle-buttons">
            <button onclick="selectVehicle('mini-car', 'mini-car.webp', 65.04)">Mini Car</button>
            <button onclick="selectVehicle('sedan-car', 'sedan-car.webp', 160.30)">Sedan Car</button>
            <button onclick="selectVehicle('flat-roof-van', 'flat-roof-van.webp',240.25)">Flat Roof Van</button>
            <button onclick="selectVehicle('high-roof-van', 'high-roof-van.webp', 350.60)">High Roof Van</button>
            <button onclick="selectVehicle('mini-coach-bus', 'mini-coach-bus.webp', 528.00)">Mini Coach Bus</button>
        </div>
...
/*document.getElementById("bookingForm").addEventListener("submit", function(event) {
    ...
    updateCartCount();
        ...
        document.getElementById("vehicle-image").src = "Mirissa-Airport-Taxi-s.webp";
        document.getElementById("vehicle-price").textContent = "$65.04 – $528.00";
        selectedPrice = 0;
        updateTotalPrice();
        document.querySelectorAll(".vehicle-buttons button").forEach(button => button.classList.remove("active"));
