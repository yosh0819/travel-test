...
<head>
    ...
    <title>Colombo Airport Taxi</title>
...
<header>
    <a href="#">Home</a> / Taxi Service / Colombo Airport Taxi
    <h1>Colombo Airport Taxi</h1>
...
<section class="taxi-details">
    <img id="vehicle-image" src="Colombo-Airport-Taxi-s.webp" alt="Colombo Taxi">
    <div class="details">
        <h2 id="vehicle-price">$27.45 – $165.27</h2>
        <p>Join us for an unforgettable Colombo Airport Taxi! Covers everything you need for a smooth and enjoyable transport.</p>
        <ul>
            <li>Colombo to Airport & Airport to Colombo</li>
            <li>Included: Transport, government tax</li>
        </ul>
        <h3>Vehicles</h3>
        <div class="vehicle-buttons">
            <button onclick="selectVehicle('mini-car', 'mini-car.webp', 27.45)">Mini Car</button>
            <button onclick="selectVehicle('sedan-car', 'sedan-car.webp', 56.30)">Sedan Car</button>
            <button onclick="selectVehicle('flat-roof-van', 'flat-roof-van.webp',95.25)">Flat Roof Van</button>
            <button onclick="selectVehicle('high-roof-van', 'high-roof-van.webp', 127.60)">High Roof Van</button>
            <button onclick="selectVehicle('mini-coach-bus', 'mini-coach-bus.webp', 165.27)">Mini Coach Bus</button>
        </div>
...
/*document.getElementById("bookingForm").addEventListener("submit", function(event) {
    ...
    updateCartCount();
        ...
        document.getElementById("vehicle-image").src = "Colombo-Airport-Taxi-s.webp";
        document.getElementById("vehicle-price").textContent = "$27.45 – $165.27";
        selectedPrice = 0;
        updateTotalPrice();
        document.querySelectorAll(".vehicle-buttons button").forEach(button => button.classList.remove("active"));
