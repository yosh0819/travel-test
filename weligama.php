...
<head>
    ...
    <title>Weligama Airport Taxi</title>
...
<header>
    <a href="#">Home</a> / Taxi Service / Weligama Airport Taxi
    <h1>Weligama Airport Taxi</h1>
...
<section class="taxi-details">
    <img id="vehicle-image" src="Weligama-Airport-Taxi-s.webp" alt="Weligama Taxi">
    <div class="details">
        <h2 id="vehicle-price">$62.35 – $509.60</h2>
        <p>Join us for an unforgettable Weligama Airport Taxi! Covers everything you need for a smooth and enjoyable transport.</p>
        <ul>
            <li>Weligama to Airport & Airport to Weligama</li>
            <li>Included: Transport, government tax</li>
        </ul>
        <h3>Vehicles</h3>
        <div class="vehicle-buttons">
            <button onclick="selectVehicle('mini-car', 'mini-car.webp', 62.35)">Mini Car</button>
            <button onclick="selectVehicle('sedan-car', 'sedan-car.webp', 143.30)">Sedan Car</button>
            <button onclick="selectVehicle('flat-roof-van', 'flat-roof-van.webp',296.25)">Flat Roof Van</button>
            <button onclick="selectVehicle('high-roof-van', 'high-roof-van.webp', 412.60)">High Roof Van</button>
            <button onclick="selectVehicle('mini-coach-bus', 'mini-coach-bus.webp', 509.60)">Mini Coach Bus</button>
        </div>
...
/*document.getElementById("bookingForm").addEventListener("submit", function(event) {
    ...
    updateCartCount();
        ...
        document.getElementById("vehicle-image").src = "Weligama-Airport-Taxi-s.webp";
        document.getElementById("vehicle-price").textContent = "$62.35 – $509.60";
        selectedPrice = 0;
        updateTotalPrice();
        document.querySelectorAll(".vehicle-buttons button").forEach(button => button.classList.remove("active"));
