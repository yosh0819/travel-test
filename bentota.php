...
<head>
    ...
    <title>Bentota Airport Taxi</title>
...
<header>
    <a href="#">Home</a> / Taxi Service / Bentota Airport Taxi
    <h1>Bentota Airport Taxi</h1>
...
<section class="taxi-details">
    <img id="vehicle-image" src="Bentota-Airport-Taxi-s.webp" alt="Bentota Taxi">
    <div class="details">
        <h2 id="vehicle-price">$51.65 – $356.16</h2>
        <p>Join us for an unforgettable Bentota Airport Taxi! Covers everything you need for a smooth and enjoyable transport.</p>
        <ul>
            <li>Bentota to Airport & Airport to Bentota</li>
            <li>Included: Transport, government tax</li>
        </ul>
        <h3>Vehicles</h3>
        <div class="vehicle-buttons">
            <button onclick="selectVehicle('mini-car', 'mini-car.webp', 51.65)">Mini Car</button>
            <button onclick="selectVehicle('sedan-car', 'sedan-car.webp', 75.30)">Sedan Car</button>
            <button onclick="selectVehicle('flat-roof-van', 'flat-roof-van.webp', 110.25)">Flat Roof Van</button>
            <button onclick="selectVehicle('high-roof-van', 'high-roof-van.webp', 150.60)">High Roof Van</button>
            <button onclick="selectVehicle('mini-coach-bus', 'mini-coach-bus.webp', 356.16)">Mini Coach Bus</button>
        </div>
...
/*document.getElementById("bookingForm").addEventListener("submit", function(event) {
    ...
    updateCartCount();
        ...
        document.getElementById("vehicle-image").src = "Bentota-Airport-Taxi-s.webp";
        document.getElementById("vehicle-price").textContent = "$51.65 – $356.16";
        selectedPrice = 0;
        updateTotalPrice();
        document.querySelectorAll(".vehicle-buttons button").forEach(button => button.classList.remove("active"));
